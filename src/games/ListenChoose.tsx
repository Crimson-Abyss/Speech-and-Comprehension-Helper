...
export const ListenChoose: React.FC<ListenChooseProps> = ({ onExit }) => {
  ...
  return (
    <div className="min-h-screen bg-gradient-candy p-4">
      ...
      <div className="max-w-2xl mx-auto mt-8 text-center">
        ...
        <div className="mb-8">
          <button
            ...
            className="w-32 h-32 rounded-full bg-white/30 backdrop-blur-lg hover:bg-white/40 transition-all shadow-2xl flex items-center justify-center mx-auto btn-press animate-pulse-glow"
          >
            ...
            return (
              ...
              >
                ...
                {showFeedback && isTarget && (
                  <div className="text-green-300 mt-2">✓ Correct!</div>
                )}
              </button>
            );
          })}
